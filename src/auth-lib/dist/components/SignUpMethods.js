...
const SignUpMethodsLib = ({ handleGoogleLogin, handleDiscordLogin, authWithStytch, authWithEthWallet, registerWithWebAuthn, authWithWebAuthn, onSendCode, onVerifyCode, connectors, error, }) => {
    ...
    return (() => (react_1.default.createElement("div", { className: "container" },
        react_1.default.createElement("div", { className: "wrapper" },
            ...
            view === 'webauthn' && (react_1.default.createElement(WebAuthn_1.WebAuthnLib, { start: "register", authWithWebAuthn: authWithWebAuthn, registerWithWebAuthn: registerWithWebAuthn, setView: setView }))))))();
};
