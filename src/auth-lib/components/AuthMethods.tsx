...
export const AuthMethodsLib = ({
  ...
  handleDiscordLogin,
  setView,
  googleIconUrl = '/google.png',
  discordIconUrl = '/discord.png',
}) => {
  return (
      ...
      <div className="social-container">
        ...
        >
          <div className="btn__icon">
            <img src={googleIconUrl} alt="Google logo" style={{ width: '100%', height: '100%' }} />
          </div>
        ...
        >
          <div className="btn__icon">
            <img src={discordIconUrl} alt="Discord logo" style={{ width: '100%', height: '100%' }} />
          </div>
