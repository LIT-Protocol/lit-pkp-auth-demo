import { AuthMethod, BaseProviderOptions, OAuthProviderOptions } from '@lit-protocol/types';
...
export default class DiscordProvider extends BaseProvider {
    ...
    static authMethodId(authMethod: AuthMethod, clientId?: string): Promise<string>;
}
