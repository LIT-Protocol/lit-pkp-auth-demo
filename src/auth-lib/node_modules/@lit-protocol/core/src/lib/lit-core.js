...
exports.LitCore = exports.DELAY_BEFORE_NEXT_EPOCH = void 0;
...
exports.DELAY_BEFORE_NEXT_EPOCH = 30000;
// export const MAX_CACHE_AGE = 30000;
class LitCore {
    // ========== Constructor ==========
    constructor(args) {
        this.epochChangeListenerSet = false;
        this.epochCache = {
            number: null,
            lastUpdateTime: null,
        };
        ...
        this.listenForNewEpoch = async () => {
            ...
            if (this.epochChangeListenerSet) {
                (0, misc_1.log)('Epoch change listener already set.');
                return;
            }
            if (this.config.litNetwork === constants_1.LitNetwork.Manzano ||
                this.config.litNetwork === constants_1.LitNetwork.Habanero ||
                ...
                stakingContract.on('StateChanged', async (state) => {
                    ...
                    }, exports.DELAY_BEFORE_NEXT_EPOCH);
        ...
        this.updateEpochCache = async (epochNumber) => {
            this.epochCache.number = epochNumber;
            this.epochCache.lastUpdateTime = Date.now();
        };
        this.getCurrentEpochNumber = async () => {
            try {
                ...
                const stakingContract = await contracts_sdk_1.LitContracts.getStakingContract(this.config.litNetwork, this.config.contractContext);
                (0, misc_1.log)('Fetching current epoch number');
        ...
        this.handleNodePromises = async (nodePromises, requestId, minNodeCount) => {
            ...
            const mostCommonError = JSON.parse((0, misc_1.mostCommonString)(errors.map((r) => JSON.stringify(r))));
