...
export interface AllowlistInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'addAdmin' | 'allowAll' | 'allowedItems' | 'isAllowed' | 'owner' | 'removeAdmin' | 'renounceOwnership' | 'setAllowAll' | 'setAllowed' | 'setNotAllowed' | 'transferOwnership'): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: 'allowedItems', values: [BytesLike]): string;
    encodeFunctionData(functionFragment: 'isAllowed', values: [BytesLike]): string;
    encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
    encodeFunctionData(functionFragment: 'removeAdmin', values: [string]): string;
    encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string;
    encodeFunctionData(functionFragment: 'setAllowAll', values: [boolean]): string;
    encodeFunctionData(functionFragment: 'setAllowed', values: [BytesLike]): string;
    encodeFunctionData(functionFragment: 'setNotAllowed', values: [BytesLike]): string;
    encodeFunctionData(functionFragment: 'transferOwnership', values: [string]): string;
    decodeFunctionResult(functionFragment: 'addAdmin', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'allowAll', data: BytesLike): Result;
    decodeFunctionResult(functionFragment: 'allowedItems', data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: 'setNotAllowed', data: BytesLike): Result;
...
export declare type AdminAddedEvent = TypedEvent<[string], AdminAddedEventObject>;
export declare type AdminAddedEventFilter = TypedEventFilter<AdminAddedEvent>;
export interface AdminRemovedEventObject {
    newAdmin: string;
}
export declare type AdminRemovedEvent = TypedEvent<[string], AdminRemovedEventObject>;
export declare type AdminRemovedEventFilter = TypedEventFilter<AdminRemovedEvent>;
export interface ItemAllowedEventObject {
    key: string;
}
export declare type ItemAllowedEvent = TypedEvent<[string], ItemAllowedEventObject>;
export declare type ItemAllowedEventFilter = TypedEventFilter<ItemAllowedEvent>;
export interface ItemNotAllowedEventObject {
    key: string;
}
export declare type ItemNotAllowedEvent = TypedEvent<[
    string
], ItemNotAllowedEventObject>;
export declare type ItemNotAllowedEventFilter = TypedEventFilter<ItemNotAllowedEvent>;
...
export interface Allowlist extends BaseContract {
    ...
    functions: {
        addAdmin(newAdmin: string, overrides?: Overrides & {
            from?: string;
        ...
        removeAdmin(newAdmin: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        renounceOwnership(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAllowAll(_allowAll: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setAllowed(key: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setNotAllowed(key: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    filters: {
        ...
        'ItemNotAllowed(bytes32)'(key?: BytesLike | null): ItemNotAllowedEventFilter;
    ...
    estimateGas: {
        ...
        allowedItems(arg0: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        allowedItems(arg0: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        isAllowed(key: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
