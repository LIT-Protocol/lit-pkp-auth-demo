import { DecryptRequest, DecryptResponse, EncryptRequest, EncryptResponse, ExecuteJsProps, ExecuteJsResponse, FormattedMultipleAccs, GetSignedTokenRequest, HandshakeWithNode, JsonExecutionRequest, KV, LitNodeClientConfig, MultipleAccessControlConditions, NodeBlsSigningShare, NodeCommandResponse, NodeCommandServerKeysResponse, RejectedNodePromises, SendNodeCommand, SignConditionECDSA, SigningAccessControlConditionRequest, SuccessNodePromises, ValidateAndSignECDSA } from './interfaces';
...
export interface ILitNodeClient {
     ...
     *
     */
    handleNodePromises<T>(nodePromises: Array<Promise<T>>): Promise<SuccessNodePromises<T> | RejectedNodePromises>;
    /**
     *
     * Throw node error
     *
