...
type StytchEvent = {
    ...
    type: StytchEventType.B2BMagicLinkEmailLoginOrSignup;
    data: B2BMagicLinkLoginOrSignupResponse;
} | {
    type: StytchEventType.B2BMagicLinkAuthenticate;
    data: B2BAuthenticateResponse;
} | {
    type: StytchEventType.B2BMagicLinkEmailDiscoverySend;
    data: B2BMagicLinksEmailDiscoverySendResponse;
} | {
    type: StytchEventType.B2BMagicLinkDiscoveryAuthenticate;
    data: B2BMagicLinksDiscoveryAuthenticateResponse;
} | {
    type: StytchEventType.B2BSSOStart;
    data: Record<string, never>;
} | {
    type: StytchEventType.B2BSSOAuthenticate;
    data: SSOAuthenticateResponse;
} | {
    type: StytchEventType.B2BDiscoveryOrganizationsCreate;
    data: B2BDiscoveryOrganizationsCreateResponse;
} | {
    type: StytchEventType.B2BPasswordAuthenticate;
    data: B2BAuthenticateResponse;
} | {
    type: StytchEventType.B2BPasswordResetByEmailStart;
    data: B2BPasswordResetByEmailStartResponse;
} | {
    type: StytchEventType.B2BPasswordResetByEmail;
    data: B2BPasswordResetByEmailResponse;
} | {
    type: StytchEventType.B2BPasswordResetBySession;
    data: B2BPasswordResetBySessionResponse;
} | {
    type: StytchEventType.B2BDiscoveryIntermediateSessionExchange;
    data: B2BDiscoveryIntermediateSessionsExchangeResponse;
} | {
    ...
    type: StytchEventType.PasskeyRegister;
    data: WebAuthnRegisterResponse;
} | {
    type: StytchEventType.PasskeyAuthenticate;
    data: WebAuthnAuthenticateResponse;
};
// More Events will go here ...
/**
 ...
 */
declare class StytchSDKNativeError extends Error {
    error_type: string;
 ...
 */
declare enum BiometricsErrors {
    BiometricsSensorError = "biometrics_sensor_error",
    DeviceCredentialsNotAllowed = "device_credentials_not_allowed",
    DeviceHardwareError = "device_hardware_error",
    InternalError = "internal_error",
    KeyInvalidated = "key_invalidated",
    KeystoreUnavailable = "keystore_unavailable",
    NoBiometricsEnrolled = "no_biometrics_enrolled",
    NoBiometricsRegistration = "no_biometrics_registration",
    SessionExpired = "session_expired",
    UserCancellation = "user_cancellation",
    UserLockedOut = "user_locked_out",
    BiometricsNotAvailable = "biometrics_not_available"
}
...
interface IHeadlessBiometricsClient {
     ...
     *
     * @throws A {@link StytchSDKNativeError} when the Stytch React Native module returns an error.
     */
