  ...
  Q = function Q(e) {
    var r = {
      isObject: function isObject(t, i) {
        ...
        if (!o) throw new C(e, t + " must be an object.");
        return r;
      },
      ...
      isString: function isString(t, n) {
        if ("string" != typeof n) throw new C(e, t + " must be a string.");
        return r;
      },
      ...
      isStringArray: function isStringArray(n, i) {
        if (!Array.isArray(i)) throw new C(e, n + " must be an array of strings.");
        var o,
          s = function (e, r) {
        ...
        try {
          for (s.s(); !(o = s.n()).done;) {
            if ("string" != typeof o.value) throw new C(e, n + " must be an array of strings.");
          }
        } catch (e) {
          s.e(e);
        } finally {
      ...
      isNumber: function isNumber(t, n) {
        if ("number" != typeof n) throw new C(e, t + " must be a number.");
        return r;
      },
      ...
      isBoolean: function isBoolean(t, n) {
        if ("boolean" != typeof n) throw new C(e, t + " must be a boolean.");
        return r;
      },
