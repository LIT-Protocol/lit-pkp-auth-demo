...
function s() {
  ...
  return g.prototype = k, o(C, "constructor", {
    ...
    return this;
  }), t.AsyncIterator = O, t.async = function (e, r, n, i, s) {
    void 0 === s && (s = Promise);
    var o = new O(h(e, r, n, i), s);
...
var z = {};
function V(e, t) {
  return T(this, void 0, void 0, s().mark(function r() {
...
var X,
  ...
  se = a(function e(t, r, n) {
    ...
    c(this, e), this.bootstrapPromise = n, this.isEnabled = function () {
      return T(i, void 0, void 0, s().mark(function e() {
        return s().wrap(function (e) {
          for (;;) switch (e.prev = e.next) {
            case 0:
      ...
      return T(i, void 0, void 0, s().mark(function r() {
        var n, i, o;
        return s().wrap(function (r) {
          for (;;) switch (r.prev = r.next) {
            case 0:
      ...
      return T(i, void 0, void 0, s().mark(function n() {
  ...
  oe = function oe() {
    return {
      isEnabled: function isEnabled() {
        return T(void 0, void 0, void 0, s().mark(function e() {
          return s().wrap(function (e) {
            for (;;) switch (e.prev = e.next) {
              case 0:
...
var ue = a(function e(t, r) {
    ...
    c(this, e), this._networkClient = t, this._subscriptionService = r, this.get = function () {
      return T(n, void 0, void 0, s().mark(function e() {
        var t, r;
        return s().wrap(function (e) {
          for (;;) switch (e.prev = e.next) {
            case 0:
      ...
      return T(n, void 0, void 0, s().mark(function t() {
        var r, n;
    ...
    function e(t, r, n, i) {
      ...
      c(this, e), this._networkClient = t, this._subscriptionService = r, this._pkceManager = n, this._passwordResetPKCEManager = i, this._config = a, this.dfpProtectedAuth = u, this.email = {
        loginOrCreate: function loginOrCreate(e) {
          ...
          return T(o, void 0, void 0, s().mark(function r() {
            var n, i, o, a, c, u, l;
            return s().wrap(function (r) {
              for (;;) switch (r.prev = r.next) {
                case 0:
  ...
  pe = a(function e(t, r) {
    ...
    c(this, e), this._networkClient = t, this._subscriptionService = r, this.executeRecaptcha = i, this.dfpProtectedAuth = o, this.sms = {
      loginOrCreate: function loginOrCreate(e, t) {
        return T(n, void 0, void 0, s().mark(function r() {
          var n, i, o, a;
          return s().wrap(function (r) {
            for (;;) switch (r.prev = r.next) {
              case 0:
      ...
      return T(n, void 0, void 0, s().mark(function n() {
        var i, o, a, c, u;
        return s().wrap(function (n) {
          for (;;) switch (n.prev = n.next) {
            case 0:
      ...
      value: function value(e) {
        ...
        return function () {
          var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            o = r.custom_scopes,
            a = r.provider_params;
          return T(t, void 0, void 0, s().mark(function t() {
            var r, c, u, l, d, h, p;
            return s().wrap(function (t) {
              for (;;) switch (t.prev = t.next) {
                case 0:
  ...
  _e = function () {
    ...
    return a(e, [{
      ...
      value: function value(e) {
        return T(this, void 0, void 0, s().mark(function t() {
          var r, n, i;
          return s().wrap(function (t) {
            for (;;) switch (t.prev = t.next) {
              case 0:
...
var Ce = {
  ...
  Pe = {
    ...
    clientExtensionResults: we(Oe, function (e) {
...
var Ne = function () {
    ...
    return a(e, [{
      ...
      value: function value(e) {
        var t, r;
        return T(this, void 0, void 0, s().mark(function n() {
          var i, o, a, c, u;
          return s().wrap(function (n) {
            for (;;) switch (n.prev = n.next) {
              case 0:
...
var ht,
  ...
  kt = ["unauthorized_credentials", "user_unauthenticated", "invalid_secret_authentication", "session_not_found"];
!function (e) {
  e.BiometricsSensorError = "biometrics_sensor_error", e.DeviceCredentialsNotAllowed = "device_credentials_not_allowed", e.DeviceHardwareError = "device_hardware_error", e.InternalError = "internal_error", e.KeyInvalidated = "key_invalidated", e.KeystoreUnavailable = "keystore_unavailable", e.NoBiometricsEnrolled = "no_biometrics_enrolled", e.NoBiometricsRegistration = "no_biometrics_registration", e.SessionExpired = "session_expired", e.UserCancellation = "user_cancellation", e.UserLockedOut = "user_locked_out", e.BiometricsNotAvailable = "biometrics_not_available";
}(ht || (ht = {})), function (e) {
  e.emailMagicLinks = "emailMagicLinks", e.sso = "sso", e.passwords = "passwords", e.oauth = "oauth";
...
var At = /*#__PURE__*/function () {
  ...
  _createClass(At, [{
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              return _context6.abrupt("return", (r.position === ut.embedded && (n.prompt_parent_id = "google-parent-prompt", n.cancel_on_tap_outside = !1), this._googleClient.initialize(n), new Promise(function (e) {
    ...
    value: function styleFrame(e) {
      e.position === ut.embedded && Array.from(document.getElementsByTagName("iframe")).forEach(function (e) {
...
var Lt = Symbol["for"]("__stytch_DataLayer"),
  Ft = function Ft(e, t) {
    var r = function () {
      var e = window;
...
var Mt = /*#__PURE__*/function () {
  ...
  _createClass(Mt, [{
    ...
    value: function _updateStateAndTokensInternal(e) {
      ...
      this._datalayer.state = r, Nt(t, r) || jt(this._datalayer.subscriptions, r);
    }
  }, {
    ...
    value: function updateState(e) {
      ...
      this._datalayer.state = r, Nt(t, r) || (jt(this._datalayer.subscriptions, r), this._datalayer.syncToLocalStorage());
    }
  }, {
    key: "updateTokens",
...
var Wt = /*#__PURE__*/_createClass(function Wt(e, t) {
  ...
  this._dataLayer = Ft(e, n), this._subscriptionService = new Ut(e, this._dataLayer);
  var v = new Ot(this._dataLayer, "passwords");
  this._networkClient = new St(e, this._dataLayer, s.endpoints.sdkBackendURL, function () {
    var e, t, r, n;
    return {
