...
const DiscordProvider_1 = tslib_1.__importDefault(require("./providers/DiscordProvider"));
const EthWalletProvider_1 = tslib_1.__importDefault(require("./providers/EthWalletProvider"));
const GoogleProvider_1 = tslib_1.__importDefault(require("./providers/GoogleProvider"));
const StytchAuthFactorOtp_1 = tslib_1.__importDefault(require("./providers/StytchAuthFactorOtp"));
...
async function getAuthIdByAuthMethod(authMethod) {
    ...
    switch (authMethod.authMethodType) {
        ...
        case constants_1.AUTH_METHOD_TYPE.GoogleJwt:
            ...
            break;
        case constants_1.AUTH_METHOD_TYPE.StytchOtp:
