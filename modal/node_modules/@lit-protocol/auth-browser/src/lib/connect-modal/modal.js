...
var l = ((n = [
        ...
        return ((i2 = o2),
            (a2 = [
                ...
                },
                {
                    key: 'showModal',
                    value: function () {
                        var e2 = this, t2 = arguments.length > 0 && void 0 !== arguments[0]
                            ? arguments[0]
                            : null;
    ...
    (r = function (e2) {
        if (!document.getElementById(e2))
            return (console.warn("MicroModal: \u2757Seems like you have missed %c'".concat(e2, "'"), 'background-color: #f8f9fa;color: #50596c;font-weight: bold;', 'ID somewhere in your code. Refer example below to resolve it.'),
                console.warn('%cExample:', 'background-color: #f8f9fa;color: #50596c;font-weight: bold;', '<div class="modal" id="'.concat(e2, '"></div>')),
                false);
    }),
    (s = function (e2, t2) {
        if (((function (e3) {
