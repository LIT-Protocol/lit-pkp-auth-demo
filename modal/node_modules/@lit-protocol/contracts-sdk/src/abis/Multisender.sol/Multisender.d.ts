...
export interface MultisenderInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'owner' | 'renounceOwnership' | 'sendEth' | 'sendTokens' | 'transferOwnership' | 'withdraw' | 'withdrawTokens'): FunctionFragment;
    encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
    encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string;
    encodeFunctionData(functionFragment: 'sendEth', values: [string[]]): string;
    encodeFunctionData(functionFragment: 'sendTokens', values: [string[], string]): string;
...
export interface Multisender extends BaseContract {
    ...
    functions: {
        ...
        sendEth(_recipients: string[], overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        sendTokens(_recipients: string[], tokenContract: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        withdrawTokens(tokenContract: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    owner(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        sendTokens(_recipients: string[], tokenContract: string, overrides?: CallOverrides): Promise<void>;
        transferOwnership(newOwner: string, overrides?: CallOverrides): Promise<void>;
        withdraw(overrides?: CallOverrides): Promise<void>;
        withdrawTokens(tokenContract: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
